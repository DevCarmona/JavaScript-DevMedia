...
document.getElementById('texto').innerHTML = "Curiosidade sobre Chuck Norris";
document.getElementById('texto1').innerHTML = "Título: " + titulo_curiosidade;
document.getElementById('texto2').innerHTML = "Conteúdo: " + conteudo_curiosidade;